...
class discosDurosSpider(scrapy.Spider):
    name = 'discos_duros'
    start_urls = [
        'https://www.solotodo.com/storage_drives'
                  ]
    flag = 2
    contador = 0
    def parse(self, response):
        ...
        discosDurosSpider.contador += len(nombre)
        ...
        pag_siguiente = 'https://www.solotodo.com/storage_drives?ordering=offer_price_usd&page='+ str(discosDurosSpider.flag) +'&'
        if discosDurosSpider.contador < limite:
            discosDurosSpider.flag += 1
