...
class ProcesadorSpider(scrapy.Spider):
    name = 'procesadores'
    start_urls = [
        'https://www.solotodo.com/processors'
                  ]
    flag = 2
    contador = 0
    def parse(self, response):
        ...
        ProcesadorSpider.contador += len(nombre)
        ...
        pag_siguiente = 'https://www.solotodo.com/processors?ordering=offer_price_usd&page='+ str(ProcesadorSpider.flag) +'&'
        if ProcesadorSpider.contador < limite:
            ProcesadorSpider.flag += 1
