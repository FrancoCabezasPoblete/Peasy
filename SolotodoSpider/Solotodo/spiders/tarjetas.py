...
class TarjetaNdviaSpider(scrapy.Spider):
    name = 'tarjetas'
    start_urls = [
        'https://www.solotodo.com/video_cards'
                  ]
    flag = 2
    contador = 0
    def parse(self, response):
        ...
        TarjetaNdviaSpider.contador += len(nombre)
        ...
        pag_siguiente = 'https://www.solotodo.com/video_cards?ordering=offer_price_usd&page='+ str(TarjetaNdviaSpider.flag) +'&'
        if TarjetaNdviaSpider.contador < limite:
            TarjetaNdviaSpider.flag +=1
